...
- `assignment_2.ipynb` — main analysis notebook containing the code, answers, outputs, and figures
- `KEN3170_Assignment_2026_e_coli_core_expression.csv` — maximal reaction activity data
- `image.png` — Escher visualization used in Part 1
- `KEN3170_Assignment_Metabolic_Modeling_10_09_2026_v2.docx` — assignment instructions
- `README.md` — this file

The notebook was executed using the *E. coli* core COBRA model provided during the course practical.  
Required Python packages include COBRApy, NumPy, pandas, Matplotlib, and seaborn.

The executed notebook is included so that the code, results, plots, and written answers can be inspected directly.
